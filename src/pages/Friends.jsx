...
const FriendsPage = () => {
  ...
  const [friendsData, setFriendsData] = useState(() => ({
    suggestions: friendsDataInitial?.suggestions || [],
    friends: friendsDataInitial?.friends || [],
    requests: {
      incoming: Array.isArray(friendsDataInitial?.requests)
        ? friendsDataInitial.requests
        : friendsDataInitial?.requests?.incoming || [],
      outgoing: Array.isArray(friendsDataInitial?.requests)
        ? []
        : friendsDataInitial?.requests?.outgoing || []
    }
  }));
